  ...
  return (
    <footer className=" text-white h-[484px] flex items-center  bg-black" >
      ...
      <div className="px-3 flex flex-col gap-8">
        ...
        <p  className=" self-end max-w-[52ch] font-ibm text-[25px] font-light leading-[42.5px]">Contact us to find out how we can help you. If it&apos;s easier you can email us at <span className="footer-links border-b border-[hsl(0,0%,67%)]" >hello@cregital.com</span> Download the <span className="footer-links border-b border-[#aaaaaa]">Cregital brochure.pdf</span> <span className="text-[#4D4D4D]">(5mb)</span> </p>
      </div>
